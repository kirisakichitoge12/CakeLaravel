...
<div style="width:100%; float:left; font-family: Helvetica; font-size:13px">
  ...
  <div style="float: left;">
    ...
    382 Võ Văn Tần, Quận 03 , TP.HCM , Việt Nam
    <br />
    <strong>
      Điện Thoại
    </strong>
    ...
    Localhost:81/shop/public/index
    <br />
    <strong>
      Email:
    </strong>
    shop.vanmy@gmail.com
  </div>
  ...
  <table style="width: 100%">
    <tr>
      <td valign="top" style="padding: 0px; width: 45%; ">
        <h3 style="font-size: 14px;margin: 1.5em 0 3px 0;">
          Thông tin đơn hàng
        </h3>
    ...
    <tr>
      <td colspan="3" valign="top" style="width: 100%">
        ...
        <table style="width:100%">
          <thead>
            <tr>
              <th style="width:55%;text-align: left;margin-left:15px;padding: 5px 0px">
                Tên Bánh
              </th>
              <th style="width:35%;text-align: center;padding: 5px 0px">
                Số lượng
              </th>
              <th style="width:25%;text-align: right;padding: 5px 0px">
                Giá
              </th>
            </tr>
          </thead>
        ...
        <div style="float: right; margin: 45px 0 1.5em 0; width: 31%;">
          <table style="font-size: 12px;width: 100%; margin: 0 0 1.5em 0;">
            <h3 style="font-size: 14px;margin: 0 0 1em 0;">
        ...
        <form action="admin/bills/capnhatdonhang/{{$dhg->id}}" method="post">
          ...
          <fieldset>
            <p style="line-height: 30px">
              <input type="radio" name="state" value="0" {{$dhg->
              state==0? "checked":""}}/> Chưa giao hàng
              <input type="radio" name="state" value="1" {{$dhg->
              state==1? "checked":""}}/> Đã giao hàng
            </p>
          </fieldset>
          <p>
