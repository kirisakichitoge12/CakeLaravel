...
class Buoi6Controller extends Controller
{
    //
    public function TruyVan1()
    {
        //Cách 01
        $dsmh_c1 = DB::table("sinhvien")->join("lophoc","sinhvien.malop", "=", "lophoc.malop")->select("masv", "hosv", "ten", "tenlop")->get();
        
        //cách 02
        $dsmh_c2 = DB::select("select masv, hosv, ten, tenlop from sinhvien inner join lophoc on sinhvien.malop=lophoc.malop ");
    ...
    {
        //Cách 01
        $dssv_c1 = DB::table("sinhvien")->select("masv","hosv", "ten", "phai")->get();
        
        //cách 02
        $dssv_c2 = DB::select("select masv, hosv, ten, phai from sinhvien");
